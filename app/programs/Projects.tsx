          ...
          <div className="flex flex-col justify-start items-start w-full h-full px-4 sm:px-8 md:px-14 py-4 sm:py-6 md:py-8">
            <div className="flex flex-col items-start justify-start w-full">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 sm:gap-6 md:gap-8 w-full mt-4">
                <div
                  className="flex flex-col items-center justify-end w-full h-[200px] sm:h-[220px] md:h-[256px] border border-foreground/50 rounded-2xl cursor-pointer transition-colors group"
                >
                  <div className="flex flex-col items-start justify-start w-full h-[94px] bg-black/20 rounded-b-2xl px-6 pt-2 pb-3 transition-all duration-300 group-hover:h-[136px] overflow-hidden">
                    ...
                    <div className="flex flex-row items-center justify-start my-3 gap-3">
                      <button
                        className="text-foreground text-xs px-2 py-1 rounded-2xl border border-foreground/50 border-0.5 hover:bg-white/10 transition-colors cursor-pointer"
                      >
                ...
                <div className="flex flex-col items-center justify-end w-full h-[200px] sm:h-[220px] md:h-[256px] border border-foreground/50 rounded-2xl cursor-pointer transition-colors group">
                  <div className="flex flex-col items-start justify-start w-full h-[62px] bg-black/20 rounded-b-2xl px-6 pt-2 pb-3 transition-all duration-300 group-hover:h-[104px] overflow-hidden">
                    ...
                    <div className="flex flex-row items-center justify-start my-3 gap-3">
                      <button className="text-foreground text-xs px-2 py-1 rounded-2xl border border-foreground/50 border-0.5 hover:bg-white/10 transition-colors cursor-pointer">
                        View Demo <span className="ml-1">→</span>
                      </button>
                      <button className="text-foreground text-xs px-2 py-1 rounded-2xl border border-foreground/50 border-0.5 hover:bg-white/10 transition-colors cursor-pointer">
                        Source Code <span className="ml-1">→</span>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 sm:gap-6 md:gap-8 w-full mt-4">
                ...
                >
                  <div className="flex flex-col items-start justify-start w-full h-[94px] bg-black/85 rounded-b-2xl px-6 pt-2 pb-3 transition-all duration-300 group-hover:h-[136px] overflow-hidden">
                    ...
                    <div className="flex flex-row items-center justify-start my-3 gap-3">
                      <a className="text-foreground text-xs px-2 py-1 rounded-2xl border border-foreground/50 border-0.5 hover:bg-white/10 transition-colors cursor-pointer"
